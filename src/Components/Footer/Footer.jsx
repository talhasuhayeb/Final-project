...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-tl from-[#99B19C] via-[#D7D1C9] to-[#FAF5EF]/40 text-[#6D2932] pt-10 pb-4 px-4 md:px-0 border-t border-[#D7D1C9]/60 shadow-inner text-xs sm:text-sm">
