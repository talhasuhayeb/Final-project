  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#FAF5EF] via-[#D7D1C9] to-[#99B19C]/40">
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 py-8">
        ...
        <div
          className="fixed top-1/2 left-0 z-50 transform -translate-y-1/2 cursor-pointer w-8 h-8 sm:w-10 sm:h-10"
          onMouseEnter={() => setSidebarOpen(true)}
          onMouseLeave={() => setSidebarOpen(false)}
          onClick={() => setSidebarOpen(!sidebarOpen)}
        >
          <div className="bg-[#99B19C] hover:bg-[#6D2932] text-[#FAF5EF] p-0.5 w-8 h-8 sm:w-10 sm:h-10 rounded-r-lg shadow flex items-center justify-center">
            <svg
